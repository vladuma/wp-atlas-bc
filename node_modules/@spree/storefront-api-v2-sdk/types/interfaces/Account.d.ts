...
export declare type AccountInfoOptions = WithCommonOptions<{
    suggestToken: true;
    suggestQuery: true;
}>;
export declare type CreditCardsListOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
    suggestQuery: true;
}>;
export declare type DefaultCreditCardOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
    suggestQuery: true;
}>;
export declare type RemoveCreditCardOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
    suggestQuery: true;
}, {
...
export declare type CompletedOrdersListOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
    suggestQuery: true;
}>;
export declare type CompletedOrderOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
    suggestQuery: true;
}, {
...
export declare type CreateOptions = WithCommonOptions<null, {
    user: {
        email: string;
        password: string;
        password_confirmation: string;
...
export declare type ConfirmOptions = WithCommonOptions<null, {
    confirmation_token: string;
}>;
export declare type ForgotPasswordOptions = WithCommonOptions<null, ForgotPasswordParams>;
export declare type ResetPasswordOptions = WithCommonOptions<null, ResetPasswordParams & {
    reset_password_token: string;
}>;
export declare type UpdateOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
}, {
    user: {
...
export declare type AddressesListOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
}>;
export declare type ShowAddressOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
    suggestQuery: true;
}, {
...
export declare type CreateAddressOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
    suggestQuery: true;
}, AccountAddressParams>;
export declare type RemoveAddressOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
}, {
    id: string;
}>;
export declare type UpdateAddressOptions = WithCommonOptions<{
    suggestToken: true;
    onlyAccountToken: true;
}, AccountAddressParams & {
    id: string;
